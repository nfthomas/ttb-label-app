...
class LabelData(BaseModel):
    ...
    net_contents: Optional[str] = Field(None, description="Volume of the container (e.g., '750 mL')")

class VerificationResult(BaseModel):
    success: bool = Field(..., description="Overall verification result")
    matches: Dict[str, bool] = Field(..., description="Fields that matched successfully")
